...
**Besluta (B)** — fattar formella beslut inom tilldelat mandat. **Bereda (Be)** — utreder, analyserar och lämnar förslag. **Verkställa (V)** — genomför fattade beslut. **Följa upp (F)** — mäter och återrapporterar resultat. **Granska (G)** — oberoende prövar om styrning och verksamhet fungerar som avsett.
...
| Tävlingsregler                        | Representantskap                    | DS, TK, kansli             | Kansli        | DS, Repr.        | Rev (tillämpliga delar) |
| Seriesammansättning seniorer          | Representantskap                    | TK, kansli                 | Kansli        | DS, Repr.        | Rev (tillämpliga delar) |
| Löpande tävlingsärenden (delegerade)  | TK eller personal                   | TK, kansli                 | Kansli        | TK, DS           | Rev (tillämpliga delar) |
| Föreningsutveckling                   | DS eller FK (per mandat)            | FK, kansli                 | Kansli        | FK, DS           | Lekmannarev             |
| Domarfrågor                           | DS, DK eller personal               | DK, kansli                 | Kansli        | DK, DS           | Rev (tillämpliga delar) |
...
| Tillsättning av tjänstepersoner       | DS                                  | DS, ordförande, DC         | DC            | DS               | Rev (tillämpliga delar) |
| Personalledning                       | DC                                  | DC                         | DC, kansli    | DS               | Rev (tillämpliga delar) |
...
| Disciplinärenden                      | Disciplinnämnden                    | Disciplinnämnden           | Kansli (adm.) | Disciplinnämnden | Rev (tillämpliga delar) |
...
| UK          | Utvecklingskommittén |
| Rev         | Revisionen           |
| Lekmannarev | Lekmannarevisionen   |
| Repr.       | Representantskapet   |
