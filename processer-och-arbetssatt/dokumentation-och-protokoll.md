---
description: >-
  Varför dokumentation är organisationens minne och vad som gäller för
  protokoll, versioner och sekretess.
---
...
Alla beslut i styrelse, kommittéer och demokratiska organ ska protokollföras. Protokollet ska vara i beslutsformat — det är besluten som dokumenteras, inte ordagranna diskussioner, justeras av utsedda justerare, arkiveras spårbart och vara tillgängligt för de som har rätt att ta del av det.
...
* vad som alltid ska publiceras,
* vad som publiceras efter beslut,
* vad som inte publiceras av integritets- eller rättssäkerhetsskäl,
* när protokoll ska publiceras,
* vem som ansvarar för publicering,
* hur äldre versioner ska arkiveras,
